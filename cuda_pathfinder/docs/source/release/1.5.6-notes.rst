...
* Add a :doc:`troubleshooting <../troubleshooting>` documentation page and
  point library-not-found error messages at it.
  (`Issue #851 <https://github.com/NVIDIA/cuda-python/issues/851>`_)
